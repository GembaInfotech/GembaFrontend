...
const MainPage = () => {
  return (
    <div className='flex justify-center items-center h-screen bg-gray-100'>
      <div className='flex flex-row max-md:flex-col bg-white shadow-lg rounded-lg overflow-hidden '>
        <div className='w-3/4 bg-gray-200 p-16 max-md:w-full'>
         
          <img src={img} alt="Parking App" className="w-full h-full object-cover drop-shadow-md "></img>
        </div>
        <div className='w-1/2 bg-white p-8 flex flex-col justify-center items-center max-md:w-full'>
