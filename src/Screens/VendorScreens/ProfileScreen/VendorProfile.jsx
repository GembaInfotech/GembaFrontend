      ...
      { vendor.status == "succeeded" && !vendor.error && vendor.data && <div className="container mx-auto  px-2 py-2">
        ...
        <div className='flex justify-between  bg-gray-100 h-[80%] '>
          <div className='px-2 py-8'>
            <p className='py-2  text-sm'><span className="  py-2 text-sm font-bold">Name:</span> {vendor?.data?.name}</p>
            <p className='py-2  text-sm'><span className="  py-2 text-sm font-bold">Phone:</span> {vendor?.data?.mob}</p>
            <p className='py-2  text-sm'><span className="  py-2 text-sm font-bold">Email:</span> {vendor?.data?.mail}</p>
            <p className='py-2  text-sm'><span className="  py-2 text-sm font-bold">Address:</span> {vendor?.data?.add}</p>
          </div>
