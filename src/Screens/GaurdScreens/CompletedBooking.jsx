...
const CompletedBooking = () => {
  ...
  const fetchGuardDetails = (carNumber) => {
    ...
    const apiUrl = carNumber
      ? `http://localhost:7001/v1/api/booking/bookings/?parkingId=65d32bed77a295e912a381e4&status=Completed&CarNumber=${carNumber}`
      : 'http://localhost:7001/v1/api/booking/bookings/?parkingId=65d32bed77a295e912a381e4&status=Completed';
  ...
  const closePopup = () => {
    ...
    setShowReceipt(false); // Close the receipt when closing the popup
  };
